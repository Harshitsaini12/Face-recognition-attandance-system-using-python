...
class face_recognition:
    def __init__(self,window):
        ...
        # top frame
        self.f1=Frame(self.window,bg="red")
        ...
        heading1=Label(self.f1,text="- Harshit Saini",font=("times new roman",20,"bold"),bg="white",fg="black").place(x=1070,y=110)

        # Buttons
        # Student_Detail_Button
        btn_img1=Image.open("Images/pic2.jpeg")
        ...
        # Detect_Image_Button
        btn_img2=Image.open("Images/pic3.jpeg")
        ...
        # Train_Data_Button
        btn_img4=Image.open("Images/pic5.jpeg")
        ...
        # Photos_Button
        btn_img5=Image.open("Images/pic6.jpeg")
        ...
        # Exit_Button
        btn_img6=Image.open("Images/pic7.jpeg")
